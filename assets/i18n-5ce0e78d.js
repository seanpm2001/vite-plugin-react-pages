import{p as i}from"./i18n_-3aff7a43.js";import{u as o,j as e}from"./ssg-client-b0099665.js";function a(t){const n=Object.assign({h1:"h1",p:"p",a:"a",h2:"h2",pre:"pre",code:"code",ul:"ul",li:"li",strong:"strong",blockquote:"blockquote",h3:"h3"},o(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"internationalization",children:"Internationalization"}),`
`,e.jsxs(n.p,{children:["i18n support can be provided by theme. For example, ",e.jsx(n.a,{href:"/official-theme",children:"the official theme(vite-pages-theme-doc)"})," support i18n. This document shows how to create a multi-lingual site with it."]}),`
...
`})}),`
`,e.jsxs(n.p,{children:["With this i18n metadata, the theme can decide which locale to apply. For any specific page, it match its pagePath with each ",e.jsx(n.code,{children:"LocalConfig.routePrefix"}),":"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["If the pagePath match with a ",e.jsx(n.code,{children:"LocalConfig.routePrefix"}),", this locale will apply to the page"]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Most site-level theme configs can decide their value based on the current applied locale. So that you can render ",e.jsx(n.code,{children:"topNavs"})," and ",e.jsx(n.code,{children:"sideNavs"})," with the correct language."]}),`
`,e.jsxs(n.li,{children:["In any React Component, you can get the current applied locale from ",e.jsx(n.code,{children:"useThemeCtx()"})," so that you can decide which i18n translated message to render."]}),`
`]}),`
...
└─ zh
   ...
   └─ nested
      └─ baz.md
`})}),`
`,e.jsxs(n.p,{children:["Each page with default locale should have its translated version. For example, ",e.jsx(n.code,{children:"/zh/foo$.md"})," should be the chinese-translated version of ",e.jsx(n.code,{children:"/foo$.md"}),"."]}),`
`,e.jsx(n.h3,{id:"markdown-pages-translate-them-into-each-locale",children:"Markdown pages: translate them into each locale"}),`
`,e.jsxs(n.p,{children:["Here is a markdown page for default locale (",e.jsx(n.code,{children:"/foo$.md"}),"):"]}),`
...
export default Page
`})}),`
`,e.jsxs(n.p,{children:["When defining the page for other locale (",e.jsx(n.code,{children:"/zh/bar$.tsx"}),"), you can ",e.jsx(n.strong,{children:"re-export the React Component"}),":"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`/**
...
`]}),`
`,e.jsx(n.h3,{id:"get-current-locale-in-react-components-or-hooks",children:"Get current locale in React Components or Hooks"}),`
...
`})})]})}function c(t={}){const{wrapper:n}=Object.assign({},o(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(a,t)})):a(t)}const s=Object.freeze(Object.defineProperty({__proto__:null,default:c},Symbol.toStringTag,{value:"Module"})),l={};l.outlineInfo=i;l.main=s;export{l as default};
