import{p as r}from"./page-data_-7fdfc5bd.js";import{u as i,j as t}from"./ssg-client-b0099665.js";import{_ as l}from"./theme.doc.d-e465cc30.js";function s(a){const e=Object.assign({h1:"h1",p:"p",strong:"strong",ul:"ul",li:"li",blockquote:"blockquote",a:"a",h2:"h2",code:"code",pre:"pre",h3:"h3"},i(),a.components),{FileText:n}=e;return n||d("FileText",!0),t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"page-data",children:"Page data"}),`
`,t.jsxs(e.p,{children:[t.jsx(e.strong,{children:"Essentially, vite-pages is a React app framework that collect your pages data and pass them to your theme."})," So what kinds of data does it collect?"]}),`
...
`,t.jsxs(e.p,{children:["Static data usually contains the matadata of a page. Static data of ",t.jsx(e.strong,{children:"all pages"})," is loaded ",t.jsx(e.strong,{children:"eagerly"})," when the app bootstrap, so that the theme can render a side menu or a search box with this infomation."]}),`
`,t.jsxs(e.blockquote,{children:[`
...
`,t.jsxs(e.li,{children:["Runtime data is loaded ",t.jsx(e.strong,{children:"lazily"})," when user navigate to that page."]}),`
...
`,t.jsxs(e.p,{children:["Vite-pages itself doesn't care what the page data looks like. How to interpret the page data and render the view, is totally decided by ",t.jsx(e.a,{href:"/theme-customization",children:"the theme"}),'. Vite-pages just collect your pages data and pass them to the theme. This design make the vite-pages core more "simple" and make themes more powerful.']}),`
...
`,t.jsxs(e.p,{children:["You may wonder why runtimeData and staticData are maps and we use a ",t.jsx(e.code,{children:"key"})," to index into them (instead of just one data for a page). This is because ",t.jsx(e.strong,{children:"vite-pages let users create a page with multiple data pieces that originate from multiple files."})]}),`
`,t.jsxs(e.blockquote,{children:[`
...
`]}),`
`,t.jsx(e.p,{children:"Most filesystem routing mechanism out there assume that each page map to only one file. But vite-pages doesn't enforce that rule! This make page data more flexible and programable."}),`
`,t.jsxs(e.p,{children:["Checkout ",t.jsx(e.a,{href:"/advanced-fs-routing",children:"the advanced-fs-routing doc"})," or ",t.jsx(e.a,{href:"/examples/component-library",children:'"Example: develop a component library"'})," to learn more about how to create a page with multiple data pieces that originate from multiple files."]})]})}function c(a={}){const{wrapper:e}=Object.assign({},i(),a.components);return e?t.jsx(e,Object.assign({},a,{children:t.jsx(s,a)})):s(a)}function d(a,e){throw new Error("Expected "+(e?"component":"object")+" `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const h=Object.freeze(Object.defineProperty({__proto__:null,default:c},Symbol.toStringTag,{value:"Module"})),o={};o.outlineInfo=r;o.main=h;export{o as default};
