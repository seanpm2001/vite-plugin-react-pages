import{p as r}from"./theme-customization_-18b6dbeb.js";import{u as s,j as t}from"./ssg-client-b0099665.js";import{_ as h}from"./theme.doc.d-e465cc30.js";const c=`import React from 'react'
...
`;function o(n){const e=Object.assign({h1:"h1",blockquote:"blockquote",p:"p",a:"a",strong:"strong",code:"code",ul:"ul",li:"li",h2:"h2",h3:"h3",pre:"pre",h4:"h4"},s(),n.components),{FileText:a}=e;return a||l("FileText",!0),t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"theme-customization",children:"Theme customization"}),`
`,t.jsxs(e.blockquote,{children:[`
`,t.jsxs(e.p,{children:["This is an advance guide about how to make a theme by yourself. If there is already themes that meet your needs(.e.g ",t.jsx(e.a,{href:"/official-theme",children:"the official theme"}),"), you don't need to read this guide now!"]}),`
`]}),`
`,t.jsxs(e.p,{children:["Vite-pages itself doesn't render any concrete DOM node. Users can customize ",t.jsx(e.strong,{children:"anything"})," with a theme. That's why theme is so powerful."]}),`
`,t.jsxs(e.p,{children:["To use a theme, users should export their theme from ",t.jsx(e.code,{children:"_theme.tsx"}),". It should export a React compoent. It will be rendered by vite-pages core, and get useful info from props:"]}),`
...
`]}),`
`,t.jsx(e.p,{children:"You can customize every bits of UI with theme. Welcome to share your theme with a npm package!"}),`
...
`,t.jsxs(e.p,{children:["We encourage theme providers to export your theme as ",t.jsx(e.strong,{children:"a config function"})," that receive user config and return a ",t.jsx(e.code,{children:"Theme"}),"."]}),`
`,t.jsx(e.p,{children:"For example, the theme provider can export theme like this:"}),`
...
`,t.jsxs(e.p,{children:["For this reason, we encourage theme providers to export config function like the ",t.jsx(e.code,{children:"createTheme"})," above."]}),`
`,t.jsxs(e.blockquote,{children:[`
...
`,t.jsx(e.p,{children:'The above example show another benefit for users: theme users can get Typescript type-check and intelliSense when they are configuring theme. This is because users are calling the theme config function, instead of "exporting some configs".'}),`
...
`,t.jsx(e.p,{children:"If you have designed and implemented a theme (.e.g a blog theme, a document site theme), welcome to add a link to your theme package in this document!"})]})}function d(n={}){const{wrapper:e}=Object.assign({},s(),n.components);return e?t.jsx(e,Object.assign({},n,{children:t.jsx(o,n)})):o(n)}function l(n,e){throw new Error("Expected "+(e?"component":"object")+" `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const u=Object.freeze(Object.defineProperty({__proto__:null,default:d},Symbol.toStringTag,{value:"Module"})),i={};i.outlineInfo=r;i.main=u;export{i as default};
