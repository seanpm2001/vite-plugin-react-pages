import{p as o}from"./_-4410e4d9.js";import{u as s,j as e}from"./ssg-client-b0099665.js";function n(i){const t=Object.assign({h1:"h1",p:"p",a:"a",ul:"ul",li:"li",strong:"strong",h2:"h2",h3:"h3",ol:"ol",code:"code"},s(),i.components);return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"-vite-plugin-react-pages",children:"📘 vite-plugin-react-pages"}),`
...
`,e.jsxs(t.li,{children:[e.jsxs(t.strong,{children:["Powerful ",e.jsx(t.a,{href:"/theme-customization",children:"theme customization"})]}),". Vite-pages itself doesn't render any concrete DOM node. You can customize ",e.jsx(t.strong,{children:"anything"})," on the page with theme. It is easy to write a theme that is sharable and configurable. If you use typescript, the users of your theme will get type-check and intelliSense."]}),`
...
`,e.jsxs(t.li,{children:[e.jsx(t.strong,{children:"Support static site generation out of the box"}),". By pre-rendering your app into HTML at buildtime, users can see the content before any JS is loaded. With this feature, you can ",e.jsx(t.a,{href:"https://github.com/vitejs/vite-plugin-react-pages/tree/main/doc-site",children:"deploy your single page apps on GitHub Pages"}),"(which ",e.jsx(t.a,{href:"https://www.google.com/search?q=github+pages+single+page+apps&oq=github+pages+single+page+apps",children:"doesn't natively support single page apps"}),")."]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.strong,{children:"Tools for Library documentation"}),". Vite-pages provides ",e.jsx(t.a,{href:"/library-documentation-tools",children:"some tools"})," to reduce the maintenance costs for library authors and make their documents more easily to read."]}),`
`]}),`
...
`,e.jsxs(t.p,{children:["Read ",e.jsx(t.a,{href:"https://vitejs.github.io/vite-plugin-react-pages/",children:"the documentation of vite-plugin-react-pages"}),"."]})]})}function a(i={}){const{wrapper:t}=Object.assign({},s(),i.components);return t?e.jsx(t,Object.assign({},i,{children:e.jsx(n,i)})):n(i)}const l=Object.freeze(Object.defineProperty({__proto__:null,default:a},Symbol.toStringTag,{value:"Module"})),r={};r.outlineInfo=o;r.main=l;export{r as default};
