import{p as o}from"./upgrade-from-v2-to-v3_-b6b89f70.js";import{u as s,j as e}from"./ssg-client-b0099665.js";function i(n){const t=Object.assign({h1:"h1",h2:"h2",p:"p",pre:"pre",code:"code",a:"a",h3:"h3",blockquote:"blockquote",strong:"strong"},s(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"upgrade-from-v2-to-v3",children:"Upgrade from v2 to v3"}),`
...
`})}),`
`,e.jsxs(t.p,{children:["Notice the version of ",e.jsx(t.code,{children:"@vitejs/plugin-react"})," need to be changed together with ",e.jsx(t.code,{children:"vite"}),"."]}),`
`,e.jsxs(t.p,{children:["We also recommend you to migrate ",e.jsx(t.code,{children:"vite-pages-theme-basic"})," to ",e.jsx(t.a,{href:"/official-theme",children:"vite-pages-theme-doc"})," with this setup (with vite v2)."]}),`
`,e.jsx(t.h2,{id:"install-peerdependencies-for-mdx",children:"Install peerDependencies for mdx"}),`
`,e.jsxs(t.p,{children:[e.jsx(t.code,{children:"vite-plugin-mdx"})," no longer install mdx-related peerDependencies for you. You should install them in your project:"]}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-json",children:`{
  "devDependencies": {
    "@mdx-js/mdx": "^1.6.22",
    "@mdx-js/react": "^1.6.22"
...
`,e.jsxs(t.p,{children:[e.jsx(t.a,{href:"https://github.com/brillout/vite-plugin-mdx",children:"vite-plugin-mdx"})," has been moved to a seperate repo. (",e.jsx(t.a,{href:"https://github.com/vitejs/vite-plugin-react-pages/issues/6",children:"related issue"}),")"]}),`
`]}),`
...
`]}),`
`,e.jsxs(t.p,{children:["In ",e.jsx(t.code,{children:"vite-plugin-react-pages@3.x"}),", vite-pages don't pass staticData to the theme component any more. You should use the hook ",e.jsx(t.code,{children:"useStaticData"})," to get staticData. This API update is for less prop drilling and more efficient HMR update during dev."]}),`
...
`]}),`
`,e.jsxs(t.p,{children:['In order to handle the change from from the fileSystem, the "Advanced Filesystem Routing" API has changed from the ',e.jsx(t.code,{children:"findPages"})," API to the ",e.jsx(t.code,{children:"pageStrategy"})," API. Checkout ",e.jsx(t.a,{href:"/advanced-fs-routing",children:"the advanced-fs-routing doc"})," to learn about the latest API."]})]})}function d(n={}){const{wrapper:t}=Object.assign({},s(),n.components);return t?e.jsx(t,Object.assign({},n,{children:e.jsx(i,n)})):i(n)}const c=Object.freeze(Object.defineProperty({__proto__:null,default:d},Symbol.toStringTag,{value:"Module"})),a={};a.outlineInfo=o;a.main=c;export{a as default};
