import{p as d}from"./index_-61b2022d.js";import{j as e,u as l}from"./ssg-client-b0099665.js";const c=`import type { MyImportedTypeAlias } from './typesUtils'
...
`,b="Button Demo1 Title",T="Button demo1 description",I={code:j,title:b,desc:T},M=!0,A=Object.freeze(Object.defineProperty({__proto__:null,default:g,demoMeta:I,isDemo:M},Symbol.toStringTag,{value:"Module"}));function s(n){const t=Object.assign({h1:"h1",p:"p",blockquote:"blockquote",h2:"h2",strong:"strong",pre:"pre",code:"code",h3:"h3",a:"a"},l(),n.components),{Demo:i,TsInfo:o,FileText:a}=t;return i||r("Demo",!0),a||r("FileText",!0),o||r("TsInfo",!0),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"library-documentation-tools",children:"Library Documentation Tools"}),`
`,e.jsx(t.p,{children:"Vite-pages provides some tools to reduce the maintenance costs for library authors and make their documents more easily to read."}),`
...
`,e.jsxs(t.p,{children:["Vite-pages allows can help you to extract Typescript type info and render it. With this feature, you ",e.jsx(t.strong,{children:"no loger need to manually maintain API infomation in your documents"}),"! You can reuse your interfaces (and comments in them) from your source code! This is very conveniently for API documentation."]}),`
