import{p as i}from"./official-theme_-d71986e6.js";import{u as s,j as n}from"./ssg-client-b0099665.js";const c=`import type { MenuConfig } from './Layout/renderMenu'
...
`;function r(o){const e=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre",a:"a",ul:"ul",li:"li",h3:"h3",strong:"strong",blockquote:"blockquote"},s(),o.components),{FileText:t}=e;return t||h("FileText",!0),n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"official-theme",children:"Official Theme"}),`
...
`,n.jsx(e.p,{children:"Doc theme can generation a side menu automatically, based on the pages information."}),`
...
`})}),`
`,n.jsxs(e.p,{children:["Firstly, the theme will divide pages into ",n.jsx(e.code,{children:"group"}),"s based on the ",n.jsx(e.strong,{children:"first segment"})," of page path:"]}),`
...
`,n.jsx(e.pre,{children:n.jsx(e.code,{children:`Put this at top of a markdown page:
---
group: references
---
...
`,n.jsxs(e.p,{children:["What is the meanings of ",n.jsx(e.code,{children:"group"})," and ",n.jsx(e.code,{children:"subGroup"}),"?"]}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"group"})," is a site isolation boundary: we only display ",n.jsx(e.strong,{children:"one"})," ",n.jsx(e.code,{children:"group"})," at a time. If a user open a page in group ",n.jsx(e.code,{children:"references"}),", he/she will ",n.jsx(e.strong,{children:"only see side menu items from that group"}),". He/She will not see menu items from ",n.jsx(e.code,{children:"components"})," group."]}),`
`,n.jsxs(e.li,{children:[n.jsx(e.code,{children:"subGroup"})," decide how the theme sort side menu items. All side menu items with same ",n.jsx(e.code,{children:"subGroup"})," will be rendered adjacently. This document site is an example."]}),`
`]}),`
...
`,n.jsxs(e.p,{children:["If the basic theme doesn't satisfy your need, you can ",n.jsx(e.a,{href:"/theme-customization",children:"create your own theme"}),"."]}),`
...
`]})]})}function l(o={}){const{wrapper:e}=Object.assign({},s(),o.components);return e?n.jsx(e,Object.assign({},o,{children:n.jsx(r,o)})):r(o)}function h(o,e){throw new Error("Expected "+(e?"component":"object")+" `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}const d=Object.freeze(Object.defineProperty({__proto__:null,default:l},Symbol.toStringTag,{value:"Module"})),a={};a.outlineInfo=i;a.main=d;export{a as default};
